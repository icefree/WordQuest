# WordQuest 词汇大冒险 (KET 专用版)

WordQuest 是一款将**背单词**与**角色扮演游戏 (RPG)** 完美融合的开源学习应用。**目前版本专为 KET 考试设计，内置 1000+ 核心必备词汇。** 通过击败地下城中的怪物、经营个性化的单词农场，让词汇学习变得象玩游戏一样充满乐趣和成就感。
...
- 📚 **KET 专项词库**：内置 1350 个精选 KET 核心词汇，覆盖考试高频考点，配有英文释义、例句、图片以及标准发音。
...
- � **精美图库**：单词卡片配备精选实景图片，拒绝生硬低质的 AI 生成图，辅助形象记忆。
